...
{
    public partial class MyProtocolsBDContext : DbContext
    {
        public MyProtocolsBDContext()
        {
        }

        public MyProtocolsBDContext(DbContextOptions<MyProtocolsBDContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //optionsBuilder.UseSqlServer("SERVER=.;DATABASE=MyProtocolsBD;INTEGRATED SECURITY=FALSE;USER ID=MyProtocolsAPIUser;PASSWORD= 123456");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Protocol>(entity =>
            {
                ...
                entity.HasMany(d => d.ProtocolStepProtocolSteps)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("ProtocolProtocolId", "ProtocolStepProtocolStepsId").HasName("PK__Protocol__7C26129519EB1EA9");
            ...
            modelBuilder.Entity<ProtocolCategory>(entity =>
            {
                entity.HasKey(e => e.ProtocolCategory1)
                    .HasName("PK__Protocol__0ED5AEE5AA078FA2");
            ...
            modelBuilder.Entity<ProtocolStep>(entity =>
            {
                entity.HasKey(e => e.ProtocolStepsId)
                    .HasName("PK__Protocol__C75F186E4E90CE00");
